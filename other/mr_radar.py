...
def radar_update(radar_layer, settings):
    ...
    # pixel edge).
    # lat_min = float(config['DEFAULT']['latitude_min'])
    # lat_max = float(config['DEFAULT']['latitude_max'])
    # lon_min = float(config['DEFAULT']['longitude_min'])
    # lon_max = float(config['DEFAULT']['longitude_max'])
    ...
    # print(radar_file)
    print("--radar " + str(raw_path) + " --lat_min " + str(lat_min) + " --lat_max " + str(lat_max) + " --lon_min " + str(lon_min) + " --lon_max " + str(lon_max) + " --x_res " + str(x_res) + " --y_res " + str(y_res))
    # print(raw_path)
    # print(lat_min)
    # print(lat_max)
    # print(lon_min)
